...
export function useUrlRef() {
  ...
  function urlRef<T extends UrlRefValue["type"]>(name: string, defaultValue: T): Ref<T> {
      ...
      return {
        get() {
          ...
          const parsedValue = parseValue(
            type,
            valueAsString !== undefined && Array.isArray(valueAsString) ? valueAsString.at(0) : valueAsString
          );
